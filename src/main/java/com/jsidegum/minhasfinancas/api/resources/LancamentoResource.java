...
import com.jsidegum.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.jsidegum.minhasfinancas.api.dto.LancamentoDTO;
	...
	*/
	...
	public ResponseEntity atualizar(@PathVariable("id") Long id, @RequestBody LancamentoDTO dto) {
		...
		return service.obterPorId(id).map(entity -> {
			...
			new ResponseEntity("Lancamento não encontrado na nossa base de dados.", HttpStatus.BAD_REQUEST));
